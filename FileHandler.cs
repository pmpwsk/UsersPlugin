...
public partial class UsersPlugin
{
    public override byte[]? GetFile(string relPath, string pathPrefix, string domain)
        => relPath switch
        {
            ...
            "/register.js" => (byte[]?)PackedFiles_ResourceManager.GetObject("File32"),
            "/settings/2fa.js" => (byte[]?)PackedFiles_ResourceManager.GetObject("File33"),
            "/settings/apps.js" => (byte[]?)PackedFiles_ResourceManager.GetObject("File34"),
            "/settings/delete.js" => (byte[]?)PackedFiles_ResourceManager.GetObject("File35"),
            "/settings/password.js" => (byte[]?)PackedFiles_ResourceManager.GetObject("File36"),
            "/settings/theme.js" => (byte[]?)PackedFiles_ResourceManager.GetObject("File37"),
            "/theme/a/blue-dark.css" => (byte[]?)PackedFiles_ResourceManager.GetObject("File38"),
            "/theme/a/blue-light.css" => (byte[]?)PackedFiles_ResourceManager.GetObject("File39"),
            "/theme/a/green-dark.css" => (byte[]?)PackedFiles_ResourceManager.GetObject("File40"),
            "/theme/a/green-light.css" => (byte[]?)PackedFiles_ResourceManager.GetObject("File41"),
            "/theme/a/none-dark.css" => (byte[]?)PackedFiles_ResourceManager.GetObject("File42"),
            "/theme/a/none-light.css" => (byte[]?)PackedFiles_ResourceManager.GetObject("File43"),
            "/theme/a/red-dark.css" => (byte[]?)PackedFiles_ResourceManager.GetObject("File44"),
            "/theme/a/red-light.css" => (byte[]?)PackedFiles_ResourceManager.GetObject("File45"),
            "/theme/a/violet-dark.css" => (byte[]?)PackedFiles_ResourceManager.GetObject("File46"),
            "/theme/a/violet-light.css" => (byte[]?)PackedFiles_ResourceManager.GetObject("File47"),
            "/theme/b/beige.css" => (byte[]?)PackedFiles_ResourceManager.GetObject("File48"),
            "/theme/b/black.css" => (byte[]?)PackedFiles_ResourceManager.GetObject("File49"),
            "/theme/b/dark.css" => (byte[]?)PackedFiles_ResourceManager.GetObject("File50"),
            "/theme/b/light.css" => (byte[]?)PackedFiles_ResourceManager.GetObject("File51"),
            "/theme/b/white.css" => (byte[]?)PackedFiles_ResourceManager.GetObject("File52"),
            "/theme/base.css" => (byte[]?)PackedFiles_ResourceManager.GetObject("File53"),
            "/theme/d/flat.css" => (byte[]?)PackedFiles_ResourceManager.GetObject("File54"),
            "/theme/d/layers.css" => (byte[]?)PackedFiles_ResourceManager.GetObject("File55"),
            "/theme/d/shadows.css" => (byte[]?)PackedFiles_ResourceManager.GetObject("File56"),
            ...
            "/users/user.js" => (byte[]?)PackedFiles_ResourceManager.GetObject("File57"),
            "/verify.js" => (byte[]?)PackedFiles_ResourceManager.GetObject("File58"),
            "/verify/change.js" => (byte[]?)PackedFiles_ResourceManager.GetObject("File59"),
            _ => null
        };
